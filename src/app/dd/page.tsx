...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
  ...
  <div class="grid grid-cols-1 gap-6 lg:grid-cols-12 flex relative p-4 w-full bg-white rounded-lg overflow-hidden shadow hover:shadow-md">
      <div class="grid-cols-1 sm:col-span-3">
      <div class="mx-auto flex h-[80px] w-[80px] items-center justify-center rounded-full bg-blue-100 p-4">
      ...
      <div className="col-span-1 lg:col-span-9">
        <div className="text-center lg:text-left">
          <text className="text-3x1 font-bold text-zinc-700" name="fullname">XYZ User</text>
          <p className="mt-2 text-zinc-500">UI/UX Designer</p>
          <p className="mt-2 text-sm font-semibold text-zinc-700">Posts</p>
          <p className="font-bold text-zinc-700">200k</p>
          <p className="mt-2 text-zinc-500">UI/UX Designer</p>
          <button className="rounded-xl border-2 border-blue-500 bg-white px-1 py-1 font-semibold text-blue-500 hover:bg-blue-500 hover:text-white">Book</button>
          <button class="rounded-xl border-2 border-blue-500 bg-white px-1 py-1 font-semibold text-blue-500 hover:bg-blue-500 hover:text-white">Profile</button>
          <button class="rounded-xl border-2 border-blue-500 bg-white px-1 py-1 font-semibold text-blue-500 hover:bg-blue-500 hover:text-white">Delete</button>
        </div>
      </div>
      </div>
