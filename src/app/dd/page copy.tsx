...
<main className="w-screen border border-red-500 border-solid mx-4 my-8 grid grid-cols-3 gap-4">
    <div className="container mx-auto">
    <div className="flex flex-wrap m-2 text-center">
      <div className="p-2 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-200">
